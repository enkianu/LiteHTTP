        ...
        <link rel="stylesheet" href="assets/ThirdParty/proxypanel/modules/Ionicons/css/ionicons.min.css">
        <link rel="stylesheet" href="assets/ThirdParty/proxypanel/modules/datatables.net-bs/css/dataTables.bootstrap.min.css">
        <link rel="stylesheet" href="assets/ThirdParty/proxypanel/css/AdminLTE.min.css">
        <link rel="stylesheet" href="assets/ThirdParty/proxypanel/modules/Ionicons/css/ionicons.min.css">
        <link rel="stylesheet" href="assets/ThirdParty/proxypanel/css/skin-black.min.css">
...
<div class="page-content" style="padding-bottom: 70px;">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Proxy Panel</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Proxy Panel  </li>
          </ul>
        </div>
        ...
        <script src="assets/ThirdParty/proxypanel/modules/jquery/dist/jquery.min.js"></script>
        <script src="assets/ThirdParty/proxypanel/modules/bootstrap/js/bootstrap.min.js"></script>
        <script src="assets/ThirdParty/proxypanel/modules/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="assets/ThirdParty/proxypanel/modules/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
        <script src="assets/ThirdParty/proxypanel/modules/jquery-slimscroll/jquery.slimscroll.min.js"></script>
        <script src="assets/ThirdParty/proxypanel/js/adminlte.min.js"></script>
        <script>
                                                    var exUrls = [
