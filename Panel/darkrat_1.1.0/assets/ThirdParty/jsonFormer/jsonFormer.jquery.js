 ...
 * @realAuthor John Snook 
 * @repack&Mod Darkspider
 */
$.widget('jsnook.jsonFormer', {
    options: {
        ...
        booleanTemplate: '<div id="json-boolean" class="form-group row"><label for="" class="control-label col-sm-2 col-form-label"></label><div class="col-sm-10"><input type="button" class="btn btn-primary" data-toggle="button" aria-pressed="false" autocomplete="off" /></div></div>',
    ...
    _makeForm: function () {
        ...
        container.addClass("darkspiderform-"+this.options.id); 
        container.attr("data-spiderapitype",this.options.type);
        ...
        container.append("<button type='button'  class='btn btn-default submitspiderform'  id='darkspiderform-"+this.options.id+"' > Save Changes </button>");
    },
    /**
     * Redraws the form
     * @returns jQuery
            ...
            switch (typeof (val)) {
                ...
                case "string":
                    if ($.isNumeric(key)) {
                        ...
                        $(box).find('input')
                                .attr('id', pKey)
                                .attr('name',pKey.replaceAll("form-","") )
                                .attr('value', val)
                                .attr('data-original', val)
                ...
                case "boolean":
                    ...
                    var btn = $(box).find('input').attr('id', pKey);
                    if (val === true) {
