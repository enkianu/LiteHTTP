          ...
          $('#vmap').vectorMap({
              ...
              colors: (function (data) {
                  ...
                  for (cc in data) {
                      ...
                      for(var color in riskIndexColors)
                          if(val >= riskIndexColors[color])
                              c[cc] = color;
                  }
              ...
              onRegionOver: function(event, code, countryName)
              {
                  if(!riskIndexData[code])
              ...
              onLabelShow: function(event, label, code) {
                  ...
                  else
                  {
                      ...
                      label.html('<strong style="color: #1b6293;"><b>' +countryName + '</b></strong>' + '<span style="color: #1b6293;">' + '<br />Risk Index: ' + riskIndexData[code] +'</span>');
                  }
              },
  
              onZoomChange: function(event, oldStep, newStep) {
                  $('.zoombox').removeClass('active');
                  $('.zoombox[data-zoomlevel="' + newStep + '"]').addClass('active');
